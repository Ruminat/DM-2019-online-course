...
% }
\hiddenTask{
  Задана функция~$M(w)$, аргументом которой является слово русского языка. Результатом её является мультимножество из букв данного слова (регистр букв имеет значение, т.\,е. «Ф»~и~«ф» "--- разные элементы). К примеру,
  \begin{equation}
    M(\text{Математика}) = \qty{\text{М}, \, \text{а}, \, \text{т}, \, \text{е}, \, \text{м}, \, \text{а}, \, \text{т}, \, \text{и}, \, \text{к}, \, \text{а}}.
  \end{equation}
  Определите, равны ли мультимножества:
  \begin{enumerate}[a)]%
    \item $ M(\text{Бар}) $ и $ M(\text{Раб}) $.
    \item $ M(\text{синус}) $ и $ M(\text{косинус}) $.
    \item $ M(\text{марка}) $ и $ M(\text{карма}) $.
    \item $ M(\text{МаТематИкА}) $ и $ M(\text{маТеМАтИка}) $.
  \end{enumerate}
}
\hiddenAnswer{a, b) не равны \ c, d) равны.}
...
\hiddenTask{%
  Дано единичное множество~$\mathfrak J$, которое является множеством решений уравнения:
  \begin{equation}
    \cos x = \sin x.
  \end{equation}
  Даны так же множества~$ A_1 $~и~$ A_2 $:
  \begin{equation}
    A_1 = \qty{-\frac{3\pi}{4}}, \ A_2 = \qty{\frac{\pi}{4}}.
  \end{equation}
  Выпишите все конституенты, укажите, являются ли множества~$ A_1 $~и~$ A_2 $ независимыми.
}
\hiddenAnswer{%
  Конституенты: $ \varnothing, \, \qty{-\frac{3\pi}{4}}, \, \qty{\frac{\pi}{4}}, \, \mathfrak J \setminus \qty{-\frac{3\pi}{4}, \, \frac{\pi}{4}} $. Множества~$ A_1 $~и~$ A_2 $ зависимы.
}
